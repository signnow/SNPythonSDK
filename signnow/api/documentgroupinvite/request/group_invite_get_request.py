...
class GroupInviteGetRequest(RequestInterface):
    """
    Represents a request to get a group invite.
    """

    def __init__(self):
        """Constructs a new GroupInviteGetRequest."""
        self._uri_params: Dict[str, str] = {}

    def with_document_group_id(self, document_group_id: str) -> "GroupInviteGetRequest":
        """
        ...
        Returns:
            The current GroupInviteGetRequest instance.
        """
        self._uri_params["document_group_id"] = document_group_id
        return self

    def with_invite_id(self, invite_id: str) -> "GroupInviteGetRequest":
        """
