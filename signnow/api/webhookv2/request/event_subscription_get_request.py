...
class EventSubscriptionGetRequest(RequestInterface):
    """
    Represents a request to get an event subscription.
    """

    def __init__(self):
        """Initializes a new EventSubscriptionGetRequest."""
    ...
    def with_event_subscription_id(
        ...
        Returns:
            This EventSubscriptionGetRequest instance.
        """
