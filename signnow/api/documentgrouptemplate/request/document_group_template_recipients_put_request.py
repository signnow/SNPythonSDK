...
class DocumentGroupTemplateRecipientsPutRequest(RequestInterface):
    """
    Represents a request to update document group template recipients.
    """
    ...
    def __init__(
        ...
        """
        Constructs a new DocumentGroupTemplateRecipientsPutRequest.
